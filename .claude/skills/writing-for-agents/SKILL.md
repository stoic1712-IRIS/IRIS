...
**STOIC-IRIS boundary:** in this project `AGENTS.md`, `CLAUDE.md`, `.claude/settings.json`, and hooks are governance-controlled. Use this reference to _draft_ improvements, but deliver them as a proposal for Founder review inside a bounded objective — never edit them directly to make a task easier, and never weaken the rules they carry. Ordinary skills and docs follow the normal bounded-path workflow.
